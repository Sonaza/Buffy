...
Addon:AddBuffItems(BUFFY_CONSUMABLES.FOODS, LE.CONSUMABLE_CATEGORY.BFA, LE.STAT.HASTE, 			{ 166804, 154884, 154883, });
Addon:AddBuffItems(BUFFY_CONSUMABLES.FOODS, LE.CONSUMABLE_CATEGORY.BFA, LE.STAT.MASTERY, 		{ 166804, 154888, 154887, });
Addon:AddBuffItems(BUFFY_CONSUMABLES.FOODS, LE.CONSUMABLE_CATEGORY.BFA, LE.STAT.CRIT,			{ 166804, 154882, 154881, });
Addon:AddBuffItems(BUFFY_CONSUMABLES.FOODS, LE.CONSUMABLE_CATEGORY.BFA, LE.STAT.VERSATILITY, 	{ 166804, 154886, 154885, });
 Addon:AddBuffItems(BUFFY_CONSUMABLES.FOODS, LE.CONSUMABLE_CATEGORY.BFA, LE.STAT.STAMINA, 		{ 166344, 166343 }); -- No stamina foods
